        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotificationSettings_DesktopNotificationsEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    NotificationSettings_DesktopBadgeCountEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    NotificationSettings_WebNotificationsEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    NotificationSettings_WebBadgeCountEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    NotificationSettings_EmailNotificationsEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    NotificationSettings_EmailWhenOfflineEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    NotificationSettings_PushNotificationsEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    NotificationSettings_PushWhenOfflineEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    NotificationSettings_DailySummaryEmailEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    NotificationSettings_DoNotDisturbStart = table.Column<TimeSpan>(type: "interval", nullable: true),
                    NotificationSettings_DoNotDisturbEnd = table.Column<TimeSpan>(type: "interval", nullable: true),
                    NotificationSettings_PreferredLanguage = table.Column<string>(type: "text", nullable: true),
                    ChatEntityId = table.Column<Guid>(type: "uuid", nullable: true),
                    FreelancerTeamEntityId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangeNotes = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedById = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastModifiedById = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateTable(
                name: "UserPaymentGatewayCustomers",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    PaymentProviderId = table.Column<Guid>(type: "uuid", nullable: false),
                    CustomerIdInProvider = table.Column<string>(type: "text", nullable: false),
                    CreatedById = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastModifiedById = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPaymentGatewayCustomers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserPaymentGatewayCustomers_TransactionProviders_PaymentPro~",
                        column: x => x.PaymentProviderId,
                        principalTable: "TransactionProviders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserPaymentGatewayCustomers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPaymentGatewayCustomers_PaymentProviderId",
                table: "UserPaymentGatewayCustomers",
                column: "PaymentProviderId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPaymentGatewayCustomers_UserId",
                table: "UserPaymentGatewayCustomers",
                column: "UserId");
